...
// JSONFormatter writes pretty-printed JSON.
...
// JSONLFormatter writes one JSON object per line.
...
// writeJSONError writes a JSON error to the writer.
...
// writeTextError writes a plain text error to the writer.
