...
- **Cloud Machines** — SSH, exec, tmux, file transfer, firewall, port forwarding
- **Files** — upload, download, grep, glob, semantic search, FUSE mount, cloud sync
...
- **Secrets** — create, mount, and manage encrypted secrets
...
| `file` | list, read, write, create, edit, delete, rename, move, mkdir, grep, glob, search, upload, download, mount, sync | File operations |
...
| `machine` | list, create, get, edit, start, stop, terminate + exec, tmux, file, dir, firewall, user, port, env | Machine management |
