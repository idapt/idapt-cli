...
export const VERB_OVERRIDES: Record<string, string> = {
  ...
  "credential edit": "credential update",
  ...
  "utility secret-list": "credential list",
  "utility secret-create": "credential create",
  ...
  "computer local-inference-install": "computer add-local-model",
};
...
export const COLLAPSED_OPS: Record<string, string> = {
...
const RESOLVED_FIELD_TO_V1: Record<string, string> = {
  ...
  resolved_credential_ids: "credentials",
...
export function mapArgsToV1(
  ...
  if (reconciled === "notification update" && path === "notification read") {
    if (out.is_read === undefined) out.is_read = true;
  }
