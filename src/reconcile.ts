...
import { reconcileToV1 } from "@idapt/api-contracts/v1/agent-grammar";

export {
  reconcileToV1,
  VERB_OVERRIDES,
} from "@idapt/api-contracts/v1/agent-grammar";
...
export function mapArgsToV1(
  ...
  for (const key of Object.keys(out)) {
    if (key.toLowerCase().startsWith("resolved_")) delete out[key];
  }
